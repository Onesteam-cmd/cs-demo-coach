...
Write-Host ""
Write-Host "=== 2) Build loss patterns ==="
& $Py ".\backend\analyzers\loss_pattern_analyzer_v0_1.py" `
    --match-id $MatchId `
    --player $Player `
    --data-dir "data"
...
$Files = @(
    ...
    ".\data\analysis\$MatchId\loss_patterns_${Player}_v0_1.csv"
)
...
Write-Host ""
Write-Host "=== LOSS PATTERN LAYER COMPLETE ==="
