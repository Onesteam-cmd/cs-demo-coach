...
Write-Host ""
Write-Host "=== 1) Ensure phase profile ==="
& ".\scripts\build_phase_profile_v0_1.ps1" -MatchId $MatchId -Player $Player

Write-Host ""
Write-Host "=== 2) Build match package v0.5 ==="
& $Py ".\backend\package\match_package_builder_v0_5.py" `
    --match-id $MatchId `
    --player $Player `
    --data-dir "data"
...
$Files = @(
    ".\data\package\$MatchId\match_package_${Player}_v0_5.json",
    ".\data\package\$MatchId\match_package_index_${Player}_v0_5.csv",
...
Write-Host ""
Write-Host "=== MATCH PACKAGE v0.5 LAYER COMPLETE ==="
