...
Write-Host ""
Write-Host "=== 2) Build structured coach action plan ==="
& ".\scripts\build_coach_action_plan_v0_1.ps1" -MatchId $MatchId -Player $Player

Write-Host ""
Write-Host "=== 3) Build structured analysis manifest ==="
& $Py ".\backend\pipeline\structured_analysis_manifest_v0_1.py" `
    --match-id $MatchId `
    --player $Player `
    --data-dir "data"
...
$Files = @(
    ".\data\runs\$MatchId\structured_analysis_manifest_${Player}_v0_1.json",
...
Write-Host ""
Write-Host "=== STRUCTURED ANALYSIS v0.1 COMPLETE ==="
Write-Host "Manifest:"
Write-Host "  .\data\runs\$MatchId\structured_analysis_manifest_${Player}_v0_1.json"
Write-Host ""
Write-Host "Coach action plan:"
Write-Host "  .\data\verdict\$MatchId\coach_action_plan_${Player}_v0_1.json"
Write-Host ""
Write-Host "Round review queue:"
Write-Host "  .\data\reviews\$MatchId\coach_round_review_queue_${Player}_v0_1.csv"
